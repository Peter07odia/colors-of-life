...
CREATE TABLE public.user_avatars (
    ...
    avatar_generated_url TEXT, -- URL of the AI-generated avatar before upscaling
    enhancement_metadata JSONB, -- JSON metadata about enhancements applied
    quality_score INTEGER, -- Quality score of the final avatar (0-100)
